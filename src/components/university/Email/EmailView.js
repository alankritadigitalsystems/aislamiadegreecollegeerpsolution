						...
						<div className="d-flex justify-content-between align-items-center ">
							<div className="header-action">
								...
								<ol className="breadcrumb page-breadcrumb">
									<li className="breadcrumb-item"><a >App</a></li>
									<li className="breadcrumb-item"><Link href ="email">Inbox</Link></li>
							...
							<div className="col-12">
								<div className="card">
									<div className="card-header">
										<h3 className="card-title"><Link href ="/email"><i className="fa fa-arrow-left"></i></Link> Back</h3>
										<div className="card-options">
											<a ><i className="fe fe-star"></i></a>
											<a ><i className="fe fe-inbox"></i></a>
											<a ><i className="fe fe-trash"></i></a>
									...
									<div className="card-body detail">
										<div className="detail-header">
											<div className="media">
												...
												<div className="media-body">
													<p className="mb-0"><strong className="text-muted mr-1">From:</strong><a >info@gmail.com</a><span className="text-muted text-sm float-right">12:48, 23.06.2018</span></p>
										...
										<div className="mail-cnt mt-3">
											...
											<Link href ="compose">Reply</Link> or
                                    <Link href ="compose">Forward</Link>
										</div>
									</div>
								</div>
							</div>
